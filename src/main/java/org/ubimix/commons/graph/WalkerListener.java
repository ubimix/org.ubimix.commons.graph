...
/**
 * An empty stub implementing the {@link IWalkerListener} interface which could
 * be used to overload just one or two methods.
 * 
 * @author kotelnikov
 */
public class WalkerListener<S> implements IWalkerListener<S> {
